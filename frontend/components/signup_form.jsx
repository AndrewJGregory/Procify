...
class SignupForm extends React.Component {
  ...
  render() {
    ...
    if (!this.state.isSameEmail) {
      confirmEmailErrorElement = errorUtil.generateErrorElement(
        this,
    ...
    return (
      <main className="session-page">
        <header className="logo-header procify-font-large">procify</header>
        <form className="session-form" onSubmit={this.handleSubmit}>
          <section className="session-form-contents">
            ...
            />
            {errorUtil.generateErrorElement(this.props.errors, "email")}
            <input
              type="email"
            ...
            <input
              ...
              onFocus={() => this.clearAllErrors()}
            />
            {errorUtil.generateErrorElement(this.props.errors, "password")}
            <input
              type="text"
              ...
              onFocus={() => this.clearAllErrors()}
            />
            {errorUtil.generateErrorElement(this.props.errors, "username")}
            <section className="birthday-form-container">
              <div className="dob-text-container">
                <h4 className="session-form-input" id="dob-text">
                  Date of birth:
                </h4>
              </div>
            ...
            {errorUtil.generateErrorElement(this.props.errors, "birthday")}
            <div className="session-link-container">
              <button className="session-link">sign up</button>
            </div>
