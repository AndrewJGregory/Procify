...
const uiReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case SWAP_ADD_SONG_FORM_SHOW:
      return Object.assign({}, state, {
        isAddSongFormDisplayed: !state.isAddSongFormDisplayed
      });
    case SELECT_SONG_ID:
      return Object.assign({}, state, { selectedSongId: action.songId });
    ...
    case SET_DROPDOWN_MENU_COORDS:
      return Object.assign({}, state, {
        dropdownMenuXpos: action.xPos,
        dropdownMenuYpos: action.yPos
      });
    case TOGGLE_SONG_PLAYING:
      return Object.assign({}, state, { isSongPlaying: !state.isSongPlaying });
    case SET_AUDIO_SRC:
    ...
    case SELECT_HOVERED_SONG_ID:
      return Object.assign({}, state, { hoveredSongId: action.id });
    case SET_INTERVAL_ID:
      return Object.assign({}, state, { intervalId: action.id });
    case TOGGLE_SUCCESS_MSG:
      const successMsgClass =
        state.successMsgClass === "slideInDown" ? "fadeOutUp" : "slideInDown";
      return Object.assign({}, state, {
